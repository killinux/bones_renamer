...
class BonesRenamer(bpy.types.Operator):
	...
	bpy.types.Scene.Origin_Armature_Type = bpy.props.EnumProperty(items = [('mmd_english', 'MMD English bone names', 'MikuMikuDance English bone names'), 
	...
	('mblab', 'mblab bone names', 'mblab bone names before generating the complete rig'), 
	...
	('iClone7', 'iClone7 bone names', 'iClone7 bone names')], name = "Rename  bones  from :", default = 'mmd_japanese')


	bpy.types.Scene.Destination_Armature_Type = bpy.props.EnumProperty(items = [('mmd_english', 'MMD English bone names', 'MikuMikuDance English bone names'),
	 ('mmd_japanese', 'MMD Japanese bone names', 'MikuMikuDamce Japanese bone names'), 
	 ('mmd_japaneseLR', 'MMD Japanese bones names .L.R suffixes', 'MikuMikuDamce Japanese bones names with .L.R suffixes'), 
	 ('xna_lara', 'XNALara bone names', 'XNALara bone names'), 
	 ('daz_poser', 'DAZ/Poser bone names', 'DAZ/Poser/Second Life bone names'), 
	 ...
	 ('biped_sfm', 'Biped Source Film Maker bone names', 'Biped Source Film Maker bone names'), 
	 ('valvebiped', 'ValveBiped bone names', 'ValveBiped bone names'), 
	 ('iClone7', 'iClone7 bone names', 'iClone7 bone names')], name = "Rename  bones  to :", default = 'mmd_english')
